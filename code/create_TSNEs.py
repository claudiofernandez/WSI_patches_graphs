...
def main(args):
    ...
    parser.add_argument("--pretrained_gcn_models_dir",
                        default="../data/gcn_pretrained_models/[24_11_2023]_GCN_Final_BCNB_LUMINALAvsLAUMINALBvsHER2vsTNBC",
                        type=str, help='Directory where pretrained GCN models are stored.')
    parser.add_argument("--feature_extractors_dir", default="../data/feature_extractors", type=str,
                        help='Directory where feature extractors are stored.')  # "C:/Users/clferma1/Documents/Investigacion_GIT/Molecular_Subtype_Prediction/data/feature_extractors"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--graphs_dir", default="../data/BCNB/results_graphs_november_23", type=str, help='Directory where graphs are stored.') # "C:/Users/clferma1/Documents/Investigacion_GIT/Molecular_Subtype_Prediction/data/BCNB/results_graphs_november_23"
