...
def monte_carlo_cv_with_validation(
    ...
    for repeat in range(n_repeats):
        ...
        for fold_idx, (fold_train_idx, fold_val_idx) in enumerate(
            ...
            train_labels = labels[fold_train_idx]  # ✅ Get labels from current training fold
            ...
            with mlflow.start_run(run_name=run_name):
                ...
                model = ImprovedPatchGCN(**model_params).to('cuda' if torch.cuda.is_available() else 'cpu')
...
def parse_slurm_arguments():
    ...
    # MLflow parameters
    parser.add_argument("--mlflow_experiment_name", default="[26012025] [LOCAL] Fine-tune GCN on new CLARIFY Graphs MIL FE", type=str,
